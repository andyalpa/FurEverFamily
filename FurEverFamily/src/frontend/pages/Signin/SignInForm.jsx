  ...
  return (
    <div className="w-full px-12 transition-opacity duration-500 opacity-100">
      ...
      <p className="text-center text-sm text-gray-600 mt-2">
        ...
        <Link to="/signuppage" className="text-blue-600 hover:text-blue-700 hover:underline">
          Sign up here
        </Link>
      </p>
      ...
      <form onSubmit={handleLogin} className="my-8 text-sm">
        ...
        <div className="flex flex-col my-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <a href="#" className="text-blue-600 hover:text-blue-700 hover:underline mt-2 sm:mt-0">Forgot your password?</a>
        </div>
      ...
      <div className="text-sm">
        ...
        <a href="#" className="flex items-center justify-center space-x-2 text-gray-600 my-2 py-2 bg-gray-100 hover:bg-gray-200 rounded">
          <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 124.8 123.36">
            <path d="M85.36,78.92l2.72-17.76H71V49.63c0-4.86,2.38-9.59,10-9.59H88.8V24.92a94.45,94.45,0,0,0-13.75-1.2c-14,0-23.21,8.5-23.21,23.9V61.16H36.24V78.92h15.6v43.57H71V78.92Z" transform="translate(0.69 0.51)" fill="#ffffff"></path>
            <path d="M99.63,0H25.12A25.12,25.12,0,0,0,0,25.12V98.24a25.12,25.12,0,0,0,25.12,25.12H99.63a25.12,25.12,0,0,0,25.12-25.12V25.12A25.12,25.12,0,0,0,99.63,0Z" fill="#1877f2"></path>
            <path d="M85.36,78.92l2.72-17.76H71V49.63c0-4.86,2.38-9.59,10-9.59H88.8V24.92a94.45,94.45,0,0,0-13.75-1.2c-14,0-23.21,8.5-23.21,23.9V61.16H36.24V78.92h15.6v43.57H71V78.92Z" transform="translate(0.69 0.51)" fill="#ffffff"></path>
          </svg>
